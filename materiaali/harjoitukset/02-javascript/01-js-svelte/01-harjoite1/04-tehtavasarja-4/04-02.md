# Tehtäväsarja 3: Tehtävä 2 - Divin kaltainen komponentti: `AlapalkinSarake`
...
Vastaa alapalkin sarakkeiden piirtämisestä. 
Keskeinen vastuualue on varmistaa, 
...
``-props:in käyttö tapahtuu samalla tavalla kuin viimeksikin:
