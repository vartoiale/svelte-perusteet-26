### Tehtäväsarja 3: Tehtävä 3 - verkkokaupan yläpalkki
...
Koodimme näyttää nyt siis seuraavalta:

`header.svelte`:

```svelte
<script>
  import Ylarivi from '../teht08/ylarivi.svelte';
...
Katsotaan tehtävän lopuksi vielä vähän paremmin relatiivisia polkuja.
