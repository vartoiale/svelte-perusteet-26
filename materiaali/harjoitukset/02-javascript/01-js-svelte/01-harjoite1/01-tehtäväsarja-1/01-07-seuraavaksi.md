...
Tätä lähdemmekin harjoittelemaan tehtäväsarjoissa 2-4, 
joissa lähdemme rakentamaan sveltellä aiempaa html-kauppa -sivustoa uudelleen.

## Seuraavaksi

Seuraavaksi: [Tehtäväsarja 2: svelte-kauppa -sivuston komponenttien alustus](./02-00-tehtäväsarja-2.md)
